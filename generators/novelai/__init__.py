...
GENERATION_DEFAULT_PARAMETERS = {
    ...
    "use_string": False,
    "min_length": MIN_GENERATED_TOKENS,
...
MAX_GENERATION_TOKENS = subscription_data["perks"]["contextTokens"]
...
def generate(input: str, required_start_txt: str) -> str:
    ...
    output = api.generate(ids_to_b64_uint16_buf(final_sent_ids), USED_GENERATION_MODEL, GENERATION_DEFAULT_PARAMETERS)
